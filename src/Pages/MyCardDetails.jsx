...
const MyCardDetails = ({ item, reRender, setReRender }) => {
  const { photo, item_name, rating, price, customization, stock_status, _id } =
    item;
      ...
      <div className="card card-compact bg-base-100 shadow-xl h-full">
        ...
        <div className="card-body">
          ...
          <div className="">
            ...
            <p className="text-lg opacity-70 ">
              <span className="font-medium">Stuck Status :</span>{" "}
              <span className="opacity-60">{stock_status}</span>
            </p>
          </div>
          <div className=" flex gap-3">
            ...
            <button
              ...
              className="btn bg-red-500 text-white hover:bg-red-700 mt-6"
            >
